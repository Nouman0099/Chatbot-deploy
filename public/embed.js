function createChatWidget(options) {
  ...
  const styleParams = {
    ...
    bgColorFooter: options.bgColorFooter || "#1e1b4b",
    bgColorMessage: options.bgColorMessage || "#9333EA",
    fontColorMessage: options.fontColorMessage || "#FFFFFF",
    fontColorHeader: options.fontColorHeader || "#1e1b4b",
    fontColorDate: options.fontColorDate || "#1e1b4b",
    fontColorPoweredBy: options.fontColorPoweredBy || "#1e1b4b",
    bgColorPoweredByIcon: options.bgColorPoweredByIcon || "#1e1b4b",
    inputPlaceHolderColor: options.inputPlaceHolderColor || "#1e1b4b",
    userMessageFontColor: options.userMessageFontColor || "#1e1b4b",
    chatbotResponseFontColor: options.chatbotResponseFontColor || "#1e1b4b",
