          ...
          >
            {!isSecondPage ? (
              <div className={`${bgColor ? '' :'bg-indigo-800' } rounded-t-3xl px-5 flex justify-between items-center h-16`} style={bgColor ? { backgroundColor: bgColor } : {}}>
                ...
                <p className="text-white font-bold text-xl"  style={{ color: fontColor, fontSize:fontSize }}>
                  Finance for Founder
                </p>
                <div className="flex space-x-2 text-white">
                  <span>
                  ...
                  <div className="ms-4 me-9 flex flex-col">
                    {messages.map((msg, index) => (
                      <div key={index} className="my-2 space-y-3">
                        {/* User Message */}
                        <div className="flex justify-end">
                          <div className="flex flex-col text-sm px-3 pt-3 pb-1 rounded-3xl max-w-[70%]"  style={{
                          ...
                          <div className="flex justify-start">
                            {msg.bot === "Show form." ? (
                              ...
                              <div className="flex relative">
                                ...
                                <div className=" flex flex-col px-3 pt-3 pb-1 rounded-3xl max-w-[80%] ms-7"  style={{
            ...
            {!isSecondPage && (
              <div className="flex items-center space-x-3 bg-indigo-800 h-16 rounded-b-3xl px-4">
                <input
                  ...
                  disabled={isLoading}
                  placeholder="Type a message..."
                  className="px-4 py-2 rounded-full text-sm w-full outline-none placeholder:text-indigo-400 border border-indigo-600"  style={{
